package citec.wikipedia.annotation.linking;

import citec.wikipedia.annotation.pattern.DBpediaEntityPattern;
...
import citec.wikipedia.extractor.table.DBpediaProperty;
...
import citec.wikipedia.extractor.utils.UrlUtils;
import java.io.File;
...
public class AbstractEntityLinker {
    ...
    private void addPatterns(Map<String, TreeMap<String, List<String>>> alphabetInfo,String dbo_Class, String outputDir, Map<String, List<DBpediaEntity>> fileDBpediaEntities, Integer windowSize, Integer nGram) throws Exception {
        ...
        for (String fileName : fileDBpediaEntities.keySet()) {
            ...
            for (DBpediaEntity dbpediaEntity : DBpediaEntitys) {
                ...
                Set<String> nouns = FormatAndMatch.format(dbpediaEntity.getNouns());
    ...
    public List<EntityAnnotation> annotateSentences(String dbo_Class, String entity, String text, Integer windowSize, Integer nGram, Map<String, TreeMap<String, List<String>>> alphabetInfo, Set<String> propertyValues,Set<String> nouns) throws Exception {
